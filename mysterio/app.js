...
const SimulationSpaces = () => {
  ...
  useEffect(() => {
    particlesRef.current = Array.from({
      length: currentDomain.particleCount
    }, () => {
    ...
    portalsRef.current = currentDomain.availablePortals.map(portalId => {
      const theta = Math.random() * Math.PI * 2;
    ...
    const animate = () => {
      ...
      particlesRef.current.forEach(p => {
        ...
        particlesRef.current.forEach(other => {
          if (other === p) return;
          const dist3D = Math.sqrt(Math.pow(p.x - other.x, 2) + Math.pow(p.y - other.y, 2) + Math.pow(p.z - other.z, 2));
          if (dist3D < 1.5) {
  ...
  }, currentDomain.name), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: '70px',
      left: '50%',
  ...
  }, "move mouse to navigate"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: '40px',
      left: '50%',
  ...
  }, "Songs for the Simulation"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
  ...
  })), transitioning && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      top: 0,
      left: 0,
...
root.render(/*#__PURE__*/React.createElement(SimulationSpaces, null));